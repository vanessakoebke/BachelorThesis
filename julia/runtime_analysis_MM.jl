...
rust_opt_path = joinpath(base, "..", "results", "rust_results_MM_opt.csv")
cpp_path = joinpath(base, "..", "results", "cpp_results_MM.csv")
cpp_opt_path = joinpath(base, "..", "results", "cpp_results_MM_opt.csv")
...
savefig(relative_plot, joinpath(base, "..", "results", "runtime_comparison_mm_relative.png"))
